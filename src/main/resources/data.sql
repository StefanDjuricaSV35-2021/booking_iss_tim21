-- Inserting data into the accommodation table
INSERT INTO accommodation (owner_id, name, type, min_guests, max_guests, description, days_for_cancellation)
VALUES (1, 'Cozy Cottage', 0, 2, 4, 'A lovely cottage in the woods', 7);

INSERT INTO accommodation (owner_id, name, type, min_guests, max_guests, description, days_for_cancellation)
VALUES (2, 'Modern Apartment', 1, 1, 2, 'A sleek apartment in the city center', 14);

INSERT INTO accommodation (owner_id, name, type, min_guests, max_guests, description, days_for_cancellation)
VALUES (3, 'Seaside Villa', 2, 6, 10, 'A luxurious villa with a view of the ocean', 30);

----------------------------------------------------

-- Inserting users with adjusted ids
INSERT INTO "user" (id, city, country, email, name, password, phone, street, surname, type)
VALUES (7, 'New York', 'USA', 'john.doe@example.com', 'John', 'hashed_password_1', '+1 123 456 7890', '123 Main St', 'Doe', 0);

INSERT INTO "user" (id, city, country, email, name, password, phone, street, surname, type)
VALUES (8, 'London', 'UK', 'jane.smith@example.com', 'Jane', 'hashed_password_2', '+44 20 1234 5678', '456 Park Ave', 'Smith', 1);

INSERT INTO "user" (id, city, country, email, name, password, phone, street, surname, type)
VALUES (9, 'Berlin', 'Germany', 'bob.jones@example.com', 'Bob', 'hashed_password_3', '+49 30 9876 5432', '789 Oak St', 'Jones', 2);

-- Inserting additional users with adjusted ids
INSERT INTO "user" (id, city, country, email, name, password, phone, street, surname, type)
VALUES (10, 'New York', 'USA', 'user102@example.com', 'User', 'hashed_password_user102', '+1 987 654 3210', '456 Oak St', 'Lastname', 0);

INSERT INTO "user" (id, city, country, email, name, password, phone, street, surname, type)
VALUES (11, 'London', 'UK', 'user103@example.com', 'Another', 'hashed_password_user103', '+44 20 9876 5432', '789 Elm St', 'Person', 1);

INSERT INTO "user" (id, city, country, email, name, password, phone, street, surname, type)
VALUES (12, 'Berlin', 'Germany', 'admin@example.com', 'Admin', 'hashed_password_admin', '+49 30 1234 5678', '101 Maple St', 'Administrator', 2);
...
VALUES (1, 'http://example.com/photo1.jpg');

INSERT INTO accommodation_photos (accommodation_id, photos)
VALUES (1, 'http://example.com/photo2.jpg');

-- Inserting photos for the Modern Apartment (accommodation_id = 2)
INSERT INTO accommodation_photos (accommodation_id, photos)
VALUES (2, 'http://example.com/apartment_photo1.jpg');

INSERT INTO accommodation_photos (accommodation_id, photos)
VALUES (2, 'http://example.com/apartment_photo2.jpg');

-- Inserting photos for the Seaside Villa (accommodation_id = 3)
INSERT INTO accommodation_photos (accommodation_id, photos)
VALUES (3, 'http://example.com/villa_photo1.jpg');

INSERT INTO accommodation_photos (accommodation_id, photos)
VALUES (3, 'http://example.com/villa_photo2.jpg');
...
INSERT INTO accommodation_review (comment, rating, accommodation_id, user_id)
VALUES ('Wonderful place to stay!', 5, 1, 11);

INSERT INTO accommodation_review (comment, rating, accommodation_id, user_id)
VALUES ('Nice and cozy, perfect for a getaway', 4, 1, 10);

-- Inserting reviews for the Modern Apartment (accommodation_id = 2)
INSERT INTO accommodation_review (comment, rating, accommodation_id, user_id)
VALUES ('Very modern and clean', 5, 2, 7);

INSERT INTO accommodation_review (comment, rating, accommodation_id, user_id)
VALUES ('Could be better', 3, 2, 7);

-- Inserting reviews for the Seaside Villa (accommodation_id = 3)
INSERT INTO accommodation_review (comment, rating, accommodation_id, user_id)
VALUES ('Absolutely stunning views!', 5, 3, 9);

INSERT INTO accommodation_review (comment, rating, accommodation_id, user_id)
VALUES ('Overpriced for what it offers', 2, 3, 11);
...
INSERT INTO owner_review (comment, rating, reviewed_id, reviewer_id)
VALUES ('Great host, very responsive!', 5, 11, 12); -- User 11 reviewing User 12

INSERT INTO owner_review (comment, rating, reviewed_id, reviewer_id)
VALUES ('Could improve communication', 3, 9, 8); -- User 9 reviewing User 8

INSERT INTO owner_review (comment, rating, reviewed_id, reviewer_id)
VALUES ('Fantastic property management!', 5, 10, 7); -- User 10 reviewing User 7
...
INSERT INTO review_report (description, report_id, user_id)
